...
interface AlineacionCardProps {
    localTitulares: string[];
    localSuplentes: string[];
    visitaTitulares: string[];
    visitaSuplentes: string[];
    partido: Partido;
}

export default function AlineacionCard({
    localTitulares,
    localSuplentes,
    visitaTitulares,
    visitaSuplentes,
    ...
    return (
        <Card className="col-span-1 lg:col-span-2 bg-[#13161c] border-2 border-[#13161c] rounded-2xl p-6">
            <div className="mb-3 flex items-center justify-between">
                <h3 className="text-lg font-semibold text-white">Alineaciones</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {/* Equipo Local */}
                <div>
                    <h4 className="text-md font-bold text-emerald-400 mb-2">
                        {partido.local?.nombre ?? "Local"}
                    </h4>
                    <div className="mb-2 text-sm font-semibold text-gray-200 uppercase tracking-wide">
                        Titulares
                    </div>
                    ...
                    <div className="mt-4 mb-2 text-sm font-semibold text-gray-200 uppercase tracking-wide">
                        Suplentes
                    </div>
                    <ul className="space-y-2 text-sm text-gray-100">
                ...
                {/* Equipo Visita */}
                <div>
                    <h4 className="text-md font-bold text-sky-400 mb-2">
                        {partido.visita?.nombre ?? "Visita"}
                    </h4>
