      ...
      >
        ...
        <div className="flex items-center justify-center px-4">
          <div className="flex w-full items-center gap-8 lg:w-fit">
            ...
            <div className="ml-auto flex items-center gap-2 lg:ml-0 text-[#13161c]">
              <Button
                variant="outline"
        ...
        <div className="flex flex-col gap-4 overflow-y-auto px-4 text-sm">
          ...
          <form className="flex flex-col gap-4">
            <div className="flex flex-col gap-3">
              <Label htmlFor="header">Club</Label>
              <Input id="header" defaultValue={item.nameClub} />
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-3">
                <Label htmlFor="target">Partidos Jugados</Label>
                <Input id="target" defaultValue={item.pj} />
              </div>
            </div>
          </form>
        </div>
